...
local c = {
  ...
  -- accents
  red           = "#3ec195",  -- NvChad "red" (actually teal-green)
  baby_pink     = "#ab7d7d",
  pink          = "#c993b5",
  green         = "#83aa7c",
...
hi("@function.macro",        { fg = c.base0A })
hi("@method",                { fg = c.base0D })
hi("@method.call",           { fg = c.base0D })
...
hi("@lsp.type.function",     { fg = c.base0D })
hi("@lsp.type.interface",    { fg = c.base0A })
hi("@lsp.type.macro",        { fg = c.base0A })
hi("@lsp.type.method",       { fg = c.base0D })
...
-- Trouble
hi("TroubleNormal",  { bg = c.darker_black })
hi("TroubleNormalNC", { bg = c.darker_black })
